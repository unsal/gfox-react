    ...
    return <div id="content">
        <div className="row">
          <div className="col-sm-12">
            <div className="well">
              ...
              <h1 className="semi-bold">Profiller"</h1>

              <p>
                Bu Form üzerinde kişisel verilerini barındırdığınız
                profillerinizin (kurum ilişkilerinizin) tanımlama
                kayıtlarını tutabilirsiniz.
              </p>
              <p>
                Kişisel veri ile ilişkilendirdiğiniz profillerinize ait
                tanımları silemezsiniz.
              </p>
            </div>
          </div>
        </div>
        ...
        <WidgetGrid>
                    ...
                    <form className="smart-form">
                        ...
                        <section>
                          ...
                          <div className="input input-file">
                            <span className="button">
                              <input type="file" id="file" name="file" />Browse
                            </span>
                      ...
                      <fieldset>
                        ...
                        <section>
                          ...
                          <div className="inline-group">
                            <label className="checkbox">
                              <input type="checkbox" name="checkbox-inline" defaultChecked />
                              <i />Alexandra
                            </label>
                            <label className="checkbox">
                        ...
                        <div className="row">
                          <section className="col col-5">
                            ...
                            <label className="toggle">
                              ...
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Alexandra
                            </label>
                            <label className="toggle">
                              <input type="radio" name="radio-toggle" />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Anastasia
                            </label>
                            <label className="toggle">
                              <input type="radio" name="radio-toggle" />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Avelina
                            </label>
                          </section>
                          ...
                          <section className="col col-5">
                            ...
                            <label className="toggle">
                              <input type="checkbox" name="checkbox-toggle" defaultChecked />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Cassandra
                            </label>
                            <label className="toggle">
                              <input type="checkbox" name="checkbox-toggle" />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Clemencia
                            </label>
                            <label className="toggle">
                              <input type="checkbox" name="checkbox-toggle" />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Desiderata
                            </label>
                          </section>
                        </div>
                      </fieldset>
                    ...
                    <form className="smart-form">
                      ...
                      <fieldset>
                        <section>
                          ...
                          <label className="textarea state-disabled">
                            {" "}
                            <textarea rows="3" className="custom-scroll" disabled="disabled" />
                          </label>
                          ...
                          <div className="row">
                            <div className="col col-4">
                              <label className="radio state-disabled">
                                <input type="radio" name="radio" defaultChecked disabled="disabled" />
                                <i />Alexandra
                              </label>
                              <label className="radio state-disabled">
                      ...
                      <fieldset>
                          ...
                          <div className="row">
                            <div className="col col-4">
                              <label className="checkbox state-disabled">
                                <input type="checkbox" name="checkbox" defaultChecked disabled="disabled" />
                                <i />Alexandra
                              </label>
                              <label className="checkbox state-disabled">
                        ...
                        <section>
                          ...
                          <div className="inline-group">
                            <label className="checkbox state-disabled">
                              <input type="checkbox" name="checkbox-inline" defaultChecked disabled="disabled" />
                              <i />Alexandra
                            </label>
                            <label className="checkbox state-disabled">
                      ...
                      <fieldset>
                        <div className="row">
                          ...
                          <section className="col col-5">
                            ...
                            <label className="toggle state-disabled">
                              <input type="checkbox" name="checkbox-toggle" defaultChecked disabled="disabled" />
                              <i data-swchon-text="ON" data-swchoff-text="OFF" />Cassandra
                            </label>
                            <label className="toggle state-disabled">
          ...
          <div className="row">
            ...
            <article className="col-sm-12 col-md-12 col-lg-6">
              {/* Widget ID (each widget will need unique ID)*/}
              <JarvisWidget colorbutton={false} editbutton={false} custombutton={false} color="blueDark">
                <header>
                  <span className="widget-icon">
                    {" "}
                    <i className="fa fa-edit" />{" "}
                      ...
                      <fieldset>
                        ...
                        <section>
                          ...
                          <label className="textarea">
                            ...
                            <textarea rows="3" placeholder="Focus to view the tooltip" />
                            <b className="tooltip tooltip-right">
                              <i className="fa fa-warning txt-color-teal" /> Some helpful information
                            </b>
                          </label>
                        </section>
                      </fieldset>
                      ...
                      <fieldset>
                        ...
                        <section>
                          ...
                          <label className="textarea">
                            {" "}
                            <i className="icon-prepend fa fa-question-circle" />
                            <textarea rows="3" placeholder="Focus to view the tooltip" /> <b className="tooltip tooltip-left">
                              <i className="fa fa-warning txt-color-teal" /> Some helpful information
                            </b>
                          </label>
                        </section>
