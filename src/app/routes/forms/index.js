  ...
  childRoutes: [
    {
      ...
      getComponent(nextState, cb) {
        System.import("./containers/FormProfiller").then(m => {
          cb(null, m.default);
        });
      }
    },

    {
      ...
      getComponent(nextState, cb) {
        System.import("html-loader?-attrs!./content/form-validation.html").then(
          html => {
            cb(null, () => <HtmlRender html={html} />);
          }
        );
      }
    },
    {
      ...
      getComponent(nextState, cb) {
        System.import(
          "html-loader?-attrs!./content/bootstrap-form-elements.html"
        ).then(html => {
          cb(null, () => <HtmlRender html={html} />);
        });
      }
