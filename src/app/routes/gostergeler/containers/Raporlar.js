...
export default () => (
  (
    <div id="content">
      {/* <div className="row">
        <BigBreadcrumbs items={['Raporlar']} icon="fa fa-fw fa-bar-chart-o"  className="col-xs-12 col-sm-7 col-md-7 col-lg-4"/>
        <Stats />
      </div> */}
        ...
        <div className="row">
          ...
          <div className="col-sm-12">
            ...
            <div className="alert alert-info">
              ...
              <h3 className="no-margin">Raporlar</h3>
              <h5>Envanter ve KV Talep Raporlarına bu sayfadan ulaşabilirsiniz</h5>
              <ul>
                <li>Envanter Listesi
                </li>
                <li>KV Talepleri</li>
                <li>Birim Süreç Listesi</li>
                <li>Paylaşılan Kurum İstatikleri <a href="http://www.unsal.org"
                                                  target="_blank"><strong>burada <i className="fa fa-link"/> </strong>
                </a></li>
              </ul>
