          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-md-12">
                  ...
                  <section>
                    <h6>Paylaşılan Kurum</h6>
                    <SelectBox id={tanimlarID.kurumlar} isMulti='true'/>
                  </section>
                  </div>
                </div>
              </div>
            ...
            <div className="modal-footer">
              ...
              <div className="widget-body no-padding">
                {this.state.error ? <p className="alert alert alert-danger">
                    {this.state.message}
                  </p> : this.state.message != "" ? <p className="alert alert alert-success">
                    {this.state.message}
